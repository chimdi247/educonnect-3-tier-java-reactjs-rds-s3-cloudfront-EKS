...
public class S3FileUploadUtil {
    ...
    private final String bucketName = "backend-static-content-chimdi";
    ...
    public String uploadImage(MultipartFile file) throws IOException {
        ...
        return String.format("https://%s.s3.%s.amazonaws.com/%s", bucketName, Region.EU_WEST_2.id(), fileName);
    }
